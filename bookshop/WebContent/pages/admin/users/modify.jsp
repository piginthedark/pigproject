...
// 			              	Users user =  usersDAO.getById(users_id);
			              	...
			              	%>
								<div class="form-group col-md-6 form-inline" >
								  ...
								  <input name="users_name"class="form-control" type="text" value="${user.users_name}" placeholder="请输入人员的姓名">
								</div>
								<div class="form-group col-md-6 form-inline" >
								  <label class="control-label-required">密码</label>
								  <input name="users_password"class="form-control" type="password" value="${user.users_password}" placeholder="请输入人员的密码">
								</div>
								...
								<div class="form-group col-md-6 form-inline" >
								  ...
								  <c:forEach items="${roles}" var="role">
			              				...
			              				${(user.roles_id==role.roles_id)?"selected":""}>
			              				${role.roles_name}
...
// 								  ArrayList<Roles> roles = rolesDAO.getAll();
								...
								<div class="form-group col-md-6 form-inline" >
								  ...
								  <input name="users_idNum" value="${user.users_idNum}" type="text" placeholder="请输入人员的省份证号码">
								</div>
								
								<div class="form-group col-md-6 form-inline" >
								  <label class="control-label-required">手机号</label>
								  <input name="users_mobile" value="${user.users_mobile}"class="form-control" type="text" placeholder="请输入人员的手机号码">
								</div>
								
								<div class="form-group col-md-6 form-inline" >
									<label class="control-label-required">地址</label>
									<textarea name="users_address" class="form-control" rows="4" cols="40" placeholder="请输入人员的地址">${user.users_address}</textarea>
								</div>
								
								<div class="form-group col-md-6 form-inline" >
								  <label class="control-label-required">邮编</label>
								  <input name="users_postcode"value="${user.users_postcode}"class="form-control" type="text" placeholder="请输入人员的邮政编码">
								</div>
								
								<div class="form-group col-md-6 form-inline" >
								  <label class="control-label-norequired">头像</label>
								  <input name="users_portraitImg" value="${user.users_portraitImg}"class="form-control" type="file">
								</div>
						   </div>
			   ...
			   <div class="panel panel-default">
					<div class="panel-footer" style="text-align: center;">
							 <button type="button" class="btn btn-primary" onclick="navTo('/bookshop/Admin/User/List')"><i class="fa fa-fw fa-lg fa-times-circle"></i>返回</button>
							 <input name="users_id"type="hidden" value="${user.users_id}">
