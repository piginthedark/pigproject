		...
		<div class="col-md-12">
			...
			<div class="col-md-3">
				<ul class="functionTip app-breadcrumb breadcrumb">
					...
					<li class="breadcrumb-item"><a href="<%=request.getContextPath() %>/pages/admin/roles/list.jsp">职位 / 列表</a></li>
				</ul>
			</div>
		</div>
	</div>
...
// 	              ArrayList<Roles> roles = rolesDAO.getAll();
	              ...
	              for(int i = 0;i<roles.size();i++){
	                  ...
	                  <tr>
	                    ...
	                    <td>
	                    	<a href="<%=request.getContextPath() %>/pages/admin/roles/detail.html?roles_id=<%=role.getRoles_id()%>"><button class="btn btn-success" type="button">详情</button></a>
	                        <a href="<%=request.getContextPath() %>/Admin/Role/OpenModify?roles_id=<%=role.getRoles_id()%>"><button class="btn btn-warning" type="button">修改</button></a>
	                        <%
